...
def create_Select_level_button(screen, x, y):
    ...
    levelS = pygame.transform.scale(imp, (screenSizeX / 6.5, screenSizeX / 6.5))
    levelBoxS = levelS.get_rect()
    levelBoxS.center = (screenSizeX / 4, screenSizeY / 1.85)
...
def play_button_pressed(screen, full_back_button):
    ...
    for i in range(2):
        for j in range(3):
            create_Select_level_button(screen, j, i)
